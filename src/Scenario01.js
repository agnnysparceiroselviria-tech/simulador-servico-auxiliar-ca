export const Scenario01 = {
    ...
    pcaPanels: [
...

        {
            ...
            generators: [
                {
                     ...
                     * acima das caixas, conforme o diagrama original.
                     */
                    label: "GD-2",
                    x: 5660,
                    y: 3065,
            ...
            reserve: {
                // DJ aproximado do painel para encurtar a linha de reserva.
                x: 6000,
                y: 3265,
                label: "CF-QCF-0912",
                fromX: 5935
...
Scenario01.generators?.forEach(shiftItemX);
Scenario01.relays?.forEach(shiftItemX);
Scenario01.externalSources?.forEach(shiftItemX);
Scenario01.distributionPanels?.forEach(shiftItemX);
Scenario01.transformers?.forEach(shiftItemX);
Scenario01.groundSwitches?.forEach(shiftItemX);
Scenario01.incomingBreakers?.forEach(shiftItemX);
